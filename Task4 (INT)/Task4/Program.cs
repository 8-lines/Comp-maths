...
namespace Task4
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            res = NewtonKF(limes1, limes2, limes2 - limes1);
            ...
            while(error > 0.000001)
            {
                ...
                error = Math.Abs((res2 - res) / (Math.Pow(L, speed) - 1)); 
                res += (res2 - res) / (1 - Math.Pow(L, -speed));
            }
            ...
            double hOpt = Math.Ceiling( (limes2 - limes1) / (step * L * Math.Pow((0.00001 / error), 1.0 / speed)));
            ...
            m = new double[6];
            res = GaussKF(limes1, limes2, limes2 - limes1);
            ...
            hOpt = Math.Ceiling((limes2 - limes1) / (step * L * Math.Pow((0.00001 / error), 1.0 / speed)));
            hOpt = (limes2 - limes1) / hOpt;
            l1 = limes1;
            l2 = limes1 + hOpt;
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            {
                double result = 0;
                int iter = (int)(Math.Round((limes2 - l1)/step));
